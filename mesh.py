...
class Mesh:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        phi_0, d_phi_0, phi_k, d_phi_k = basis_functions
        self.phi_0 = lambda x, x0: phi_0(self, x, x0)
        self.d_phi_0 = lambda x, x0: d_phi_0(self, x, x0)
        self.phi_k = lambda x, x0, k: phi_k(self, x, x0, k)
        self.d_phi_k = lambda x, x0, k: d_phi_k(self, x, x0, k)
...
def solve(
    category, basis_functions, model_args, nx, nG, source, end_time, perturbation
):
    M = Mesh(
        category,
        model_args,
...
def run_perturbation_analysis(categories, basis_functions, model_args, **kwargs):
    nx = kwargs.get("nx", 20)
    nG = kwargs.get("nG", 2)
...
def run_and_plot(categories, basis_functions, model_args, **kwargs):
    nx = kwargs.get("nx", 20)
    nG = kwargs.get("nG", 2)
    source = kwargs.get("source", True)
